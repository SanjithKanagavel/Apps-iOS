...
- (void)insertNewObject:(id)sender {
    ...
    UIAlertController * alertController = [UIAlertController alertControllerWithTitle: @"Post a message"
                                                                              message: @"Message"
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        UITextField * headerTxt = textfields[0];
        UITextField * descriptionTxt = textfields[0];
        NSLog(@"%@:%@",headerTxt.text,descriptionTxt.text);
    ...
    /*UIAlertView *dialog = [[UIAlertView alloc] initWithTitle:@"Enter a Todo :"
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"header" ascending:NO];
    
    [fetchRequest setSortDescriptors:@[sortDescriptor]];
    
    // Edit the section name key path and cache name if appropriate.
    // nil for section name key path means "no sections".
    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"Master1"];
