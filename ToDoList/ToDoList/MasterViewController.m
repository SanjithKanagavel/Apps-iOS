...
- (void)insertNewObject:(id)sender {
    ...
    UIAlertController * alertController = [UIAlertController alertControllerWithTitle: @"Create a todo"
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        UITextField * descriptionTxt = textfields[1];
        ...
        [newManagedObject setValue:headerTxt.text forKey:@"header"];
